document.addEventListener('DOMContentLoaded', function () {
    ...
    var textElement = document.querySelector('.p1');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Reference to the text element
    var textElement = document.querySelector('.p3');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Reference to the text element
    var textElement = document.querySelector('.p4');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Reference to the text element
    var textElement = document.querySelector('.p5');
