function changeColors() {
    ...
    // Reference to all anchor elements
    var anchorElements = document.querySelectorAll('a,button');

    // If the current color is black, switch it back to white
    if (currentColor === "black") {
        document.body.style.backgroundColor = "white";
        document.body.style.color = "black"; // Change text color to black

        // Loop through all anchor elements and set color to black
        anchorElements.forEach(function(element) {
            element.style.color = "black";
        });
    } else {
        // If the current color is not black, switch it to black
        document.body.style.backgroundColor = "black";
        document.body.style.color = "white"; // Change text color to white

        // Loop through all anchor elements and set color to white
        anchorElements.forEach(function(element) {
